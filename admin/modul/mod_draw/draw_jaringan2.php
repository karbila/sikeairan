...
?>
        ...
        var dropdownIndex = document.getElementById('po').selectedIndex;

        var iddesa = "<?=$_GET[iddesa] ?>";
        var idsumber = "<?=$_GET[idsumber] ?>";
        var lat = "<?=$_GET[lat] ?>";
        var lng = "<?=$_GET[lng] ?>";
...
<?php
            ...
            $hitungRow = mysql_num_rows(mysql_query($query));
            
            // echo $hitungRow+"=========";
            // $coba ="SELECT * FROM tbl_line_pipa WHERE id_sumber = '$_GET[idsumber]'";

            if($hitungRow == 0){
?>

                document.write("<h4 class='box-judulform-tombol'> <a href='?halaman=m_draw&aksi=draw&iddesa="+iddesa+"&idsumber="+idsumber+"&lat="+lat+"&lng="+lng+"'><input type='submit' name='draw' id='draw' value='Draw' class='btn btn-inverse'> </a> </h4>");
<?php
            }else{
?>
                document.write("<h4 class='box-judulform-tombol'><a href='?halaman=m_draw&aksi=edit&iddesa="+iddesa+"&idsumber="+idsumber+"&lat="+lat+"&lng="+lng+"'><input type='submit' name='edit' id='edit' value='Edit' class='btn btn-inverse'> </a> </h4>");
<?php
            }
?>
        }
...
?>
    ...
    <script type="text/javascript">
        ...
        window.onload = function() {
<?php
            $hapus = mysql_query("DELETE FROM tbl_line_pipa WHERE id_sumber = '$_GET[idsumber]'");
?>             
            //set initial map location
            map = new google.maps.Map(
                document.getElementById("map"), mapOptions);
